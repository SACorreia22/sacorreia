...
class Template
{
     ...
     *            true for accurate block parsing
     */
     ...
     *
     * @param string  $block
     *            the block name to be parsed
     * @param boolean $append
     *            true if the content must be appended
     */
     ...
     *
     * @param string $varname
     *            contains the name of a variable to load
     * @param string $filename
     ...
     *            file content
     * @param string $varname
     *            contains the variable name of the file
     *
     ...
     *
     * @param string $line
     *            contains one line of the content file
     * @param string $varname
     *            contains the filename variable identifier
     * @param string $queued_blocks
     *            contains a list of the current queued blocks
     * @param string $blocks
     *            contains a list of all identified blocks in the current file
     *
     * @return void
     */
     ...
     *
     * @param array $blocks
     *            contains all identified block names
     * @return void
     */
     ...
     *
     * @param string $parent
     *            contains the name of the parent variable
     * @param string $block
     *            contains the name of the block to be replaced
     * @return void
     */
